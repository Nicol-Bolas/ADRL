...
class CheckPoint(object):
    ...
    def __init__(self, save_path,model_name):
        ...
        self.save_path = os.path.join(save_path, "check_point_"+model_name)
    ...
    @classmethod
    def load_state(cls,model, state_dict):
        """
    ...
    @classmethod
    def load_model_from_path(cls,model,path):
        model_state=CheckPoint.load_model(path)
